Build a Laravel Application that serves as a RESTful API for managing a Todo List. Make user registration and login, authenticated should perform CRUD operations for tasks.

<p>Please follow below step to run this application</p>
